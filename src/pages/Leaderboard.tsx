...
const Leaderboard = () => {
    ...
    const filteredData = search
        ? mockData.filter(entry => entry.name.toLowerCase().includes(search.toLowerCase()))
        : mockData;
    ...
    return (
        <div className="w-full md:p-10 flex-col justify-start items-start h-screen bg-gray-50">
            {/* Header Section */}
